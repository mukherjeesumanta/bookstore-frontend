    ...
    <footer className="bg-[#1C2215] text-[#9A9A85]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-5 gap-8 mb-10">
          ...
          {/* Community */}
          <div>
            <h3 className="text-[#FAF9F5] font-semibold text-sm mb-4">
              Community
            </h3>
            <ul className="space-y-2 text-sm">
              <li>
          ...
          <div className="col-span-2 sm:col-span-4 lg:col-span-1">
            <h3 className="text-[#FAF9F5] font-bold text-lg mb-2">
              Leaf &amp; Letter
            </h3>
          ...
          <div className="flex items-center gap-4">
            {["f", "in", "t", "li"].map((s) => (
              <a
                key={s}
                href="#"
                className="hover:text-[#FAF9F5] transition-colors text-xs font-medium uppercase"
              >
                {s}
              </a>
            ))}
