// Minimal inline SVG icons to avoid external icon dependency
...
export function ShoppingCartIcon({ className = "w-5 h-5" }) {
  return (
    <svg
      className={className}
      fill="none"
  ...
  return (
    ...
    >
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={2}
        d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-5 5a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 9V4a1 1 0 011-1z"
      />
    </svg>
  );
}
